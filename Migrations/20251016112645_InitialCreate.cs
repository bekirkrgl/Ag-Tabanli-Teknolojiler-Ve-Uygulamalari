        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AvailabilityBlocks_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Kalp ve damar hastalıkları", "Kardiyoloji" },
                    { 2, "Sinir sistemi hastalıkları", "Nöroloji" },
                    { 3, "Kemik ve eklem hastalıkları", "Ortopedi" },
                    { 4, "Cilt hastalıkları", "Dermatoloji" },
                    { 5, "Göz ve görme problemleri", "Göz Hastalıkları" },
                    { 6, "KBB hastalıkları", "Kulak Burun Boğaz" },
                    { 7, "Genel iç hastalıkları", "İç Hastalıkları" },
                    { 8, "Çocuk hastalıkları", "Çocuk Sağlığı" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AvailabilityBlocks_DoctorId",
